...
exports.run = (bot, WebhookPrivate, WebhookPublic, msg) => {
    ...
    bot.emit("guildCreate")

    console.log(bot.ls.info, bot.config.prefix + "emmitga " + " by " + msg.author.tag + " (" + msg.author.id + ")")

    WebhookPrivate.send(new Discord.RichEmbed()
        .setColor(bot.config.PrimaryColor)
        .setDescription("** " + bot.config.prefix + "emmitga ** - By " + msg.author)
